...
-- 2020-05-03
L.door_destructible = "此门可摧毁 （{health}生命值）"
...
L.loadingscreen_round_restart_subtitle_limits_mode_0 = "你正在游玩地图{map}"
L.loadingscreen_round_restart_subtitle_limits_mode_1 = "你正在游玩地图{map}，还有{rounds}回合或{time}秒换图"
L.loadingscreen_round_restart_subtitle_limits_mode_2 = "你正在游玩地图{map}，还有{time}秒换图"
L.loadingscreen_round_restart_subtitle_limits_mode_3 = "你正在游玩地图{map}，还有{rounds}回合换图"
